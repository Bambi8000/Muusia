...
export default {
  key: "potato",
    ...
    params: [
      ...
      { key: "eyes", label: "Eyes (texture)", type: "select", options: ["None", "Dots", "Arcs (eyes)"], def: "None" },
      { key: "eyeCount", label: "Eyes per potato", type: "slider", min: 1, max: 30, step: 1, def: 7 , showIf: (p) => p.eyes !== "None" },
