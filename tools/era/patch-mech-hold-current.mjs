 ...
 * silenced it; cfg now sets hold_current 1.0 on X/Y/Y1.
...
if (holds.length !== 3 || holds.some((h) => h !== "1.0")) {
  console.log(`MISS  klipper/printer.cfg has hold_current lines: ${JSON.stringify(holds)}; expected three 1.0 — apply the cfg change first`);
  process.exit(1);
}
