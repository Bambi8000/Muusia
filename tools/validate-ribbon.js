/* validate-ribbon.js — edited Ribbon (Line/Ring). Key regression test:
   Line mode must equal the baked src/defs/nodes/ribbon.js output exactly. */
const fs = require("fs");
...
const N = new Function(...Object.keys(H_), '"use strict"; return (' + fs.readFileSync(__dirname + "/ribbon_lab.plotternode.js","utf8") + ");")(...Object.values(H_));
