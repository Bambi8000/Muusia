/* tools/validate-container.mjs - runs against the BAKED node (v2.36 lesson) */
import N from "../src/defs/nodes/container.js";
import { mulberry32, pathLength } from "../src/defs/helpers.js";
