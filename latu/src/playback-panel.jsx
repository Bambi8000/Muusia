...
export default function PlaybackPanel({ timeline, time, playing, speed, autoFollow, onTime, onPlaying, onSpeed, onAutoFollow, onClose, onChapter }) {
