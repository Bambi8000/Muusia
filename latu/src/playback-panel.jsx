...
export default function PlaybackPanel({ timeline, time, playing, speed, autoFollow, penWidths, onPenWidth, onTime, onPlaying, onSpeed, onAutoFollow, onClose, onChapter }) {
